...
h2. Future, Bugs, Etc
(At least it will probably also look for a <code>.this_is_a_root_directory</code> type file so that you can manually make a project be a project according to this.)
h3. Future
